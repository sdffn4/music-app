...
import useUser from "@/hooks/react-query/queries/useUser";
import useMutateUser from "@/hooks/react-query/mutations/useMutateUser";
import ChangeableInput from "@/components/ChangeableInput";
import axios from "axios";
import { ExitIcon, TrashIcon, SunIcon } from "@radix-ui/react-icons";
      ...
      <>
        ...
        <div className="min-h-page flex flex-col items-center justify-center">
          ...
          <div className="flex flex-col">
            <button
              className="m-2 flex items-center justify-between rounded-lg bg-white p-2 text-base shadow-[0_2px_10px] shadow-neutral-800"
              onClick={toggleTheme}
            >
              <span className="px-2">Toggle theme</span>
              <span className="px-4">
                <SunIcon />
              </span>
            </button>
            ...
            <AlertDialog.Root>
              <AlertDialog.Trigger asChild>
                <button className="m-2 flex items-center justify-between rounded-lg text-red-500 bg-white p-2 text-base shadow-[0_2px_10px] shadow-neutral-800">
  ...
  return (
    <>
      ...
      <Toast.Provider swipeDirection="right">
        <div className="min-h-page flex justify-center items-center">
          <div className="flex flex-col w-[300px]">
            <p className="mb-5 text-mauve11 text-[15px] leading-normal">
              Enter an email so that we can send a magic link for you to sign
              in.
            </p>
        ...
        >
          <Toast.Title className="[grid-area:_title] mb-[5px] font-medium text-black text-sm">
            Check you email
          </Toast.Title>
